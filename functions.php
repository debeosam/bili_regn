...
function price_calculator_scripts() {
	wp_enqueue_script('jquery', get_template_directory_uri() . '/js/jquery-1.11.3.min.js', array(), '1.11.13', true);
	wp_enqueue_script('accounting', get_template_directory_uri() . '/js/accounting.js', array(), '0.4.2', true);
	wp_enqueue_script('number_format', get_template_directory_uri() . '/js/number_validation_and_formating.js', array(), '0.4.2', true);
	wp_enqueue_script('price_calculators', get_template_directory_uri() . '/js/price_calculators.es6', array(), true);
}

add_action('wp_enqueue_scripts', 'price_calculator_scripts');